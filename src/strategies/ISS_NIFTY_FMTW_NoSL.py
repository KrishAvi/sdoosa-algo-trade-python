...
class ISS_NIFTY_FMTW_NoSL(BaseStrategy):
    ...
    def __init__(self):
        ...
        self.startTimestamp = Utils.getTimeOfToDay(10, 30, 0)  # When to start the strategy. Default is Market start time
        ...
        self.squareOffTimestamp = Utils.getTimeOfToDay(15, 6, 0)  # Square off time
        ...
        self.divisionfactor = 2.6  # Friday, Monday, Tuesday DF = 3 and Wednesday DF = 2
    ...
    def process(self):
        #This rotine called at every 30 sec
        #Will check and update trade exit condtions based on threshold set
        ...
        ATMCESymbol = 'NIFTY2170115850CE'
        ATMPESymbol = 'NIFTY2170115850PE'
    ...
    def generateTrades(self, ATMCESymbol, ATMPESymbol, FUTURESymbol, FUTURESymbolSpotPrice):
        ...
        slFactor = Utils.roundToNSEPrice(
            (quoteATMCESymbol.lastTradedPrice + quoteATMPESymbol.lastTradedPrice) / self.divisionfactor)
