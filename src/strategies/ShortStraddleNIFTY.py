...
class ShortStraddleNIFTY(BaseStrategy):
  ...
  def __init__(self):
    ...
    self.startTimestamp = Utils.getTimeOfToDay(10, 0, 0) # When to start the strategy. Default is Market start time
    ...
    self.capital = 110000 # Capital to trade (This is the margin you allocate from your broker account for this strategy)
    self.leverage = 0
